...
public class MyAccountsTest extends Utility
{
    ...
    public void verifyThatUserRegisterAccountSuccessfully()
    {
        ...
        driver.findElement(By.xpath("//input[@id='input-firstname']")).sendKeys("Mani");

        //3.4 Enter Last Name
        driver.findElement(By.xpath("//input[@id='input-lastname']")).sendKeys("Meghji");

        //3.5 Enter Email
        driver.findElement(By.xpath("//input[@id='input-email']")).sendKeys("mani123@gmail.com");

        //3.6 Enter Telephone
        driver.findElement(By.xpath("//input[@id='input-telephone']")).sendKeys("09876566478");


        //3.7 Enter Password
        driver.findElement(By.xpath("//input[@id='input-password']")).sendKeys("Mani0077");

        //3.8 Enter Password Confirm
        driver.findElement(By.xpath("//input[@id='input-confirm']")).sendKeys("Mani0077");
